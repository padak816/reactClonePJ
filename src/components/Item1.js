...
function Item1(){
	...
	const onClick = () => {
		...
		localStorage.setItem('item1', JSON.stringify(object));
		...
		<>
			<div id="sit_ov_wrap">
					...
					<div id="sit_pvi">
						...
						<img src="../data/item/1553136048/thumb-1000653_570x372.jpg" width="570" height="372" alt=""/></a>
						<a href="largeimage91f5.html?it_id=1553136048&amp;no=2" target="_blank" className="popup_item_image">
						<img src="../data/item/1553136048/thumb-1000653CYAN_570x372.jpg" width="570" height="372" alt=""/></a>
						<a href="largeimagebae2.html?it_id=1553136048&amp;no=3" target="_blank" className="popup_item_image">
						<img src="../data/item/1553136048/thumb-1000653PINK_570x372.jpg" width="570" height="372" alt=""/></a>
						<a href="largeimage5814.html?it_id=1553136048&amp;no=4" target="_blank" className="popup_item_image">
						<img src="../data/item/1553136048/thumb-10006532IN_570x372.jpg" width="570" height="372" alt=""/></a>       
					</div>
						...
						<img src="../data/item/1553136048/thumb-1000653_134x108.jpg" width="134" height="108" alt=""/>
						...
						<img src="../data/item/1553136048/thumb-1000653CYAN_134x108.jpg" width="134" height="108" alt=""/>
						...
						<img src="../data/item/1553136048/thumb-1000653PINK_134x108.jpg" width="134" height="108" alt=""/>
						...
						<img src="../data/item/1553136048/thumb-10006532IN_134x108.jpg" width="134" height="108" alt=""/>
					...
					<section id="sit_ov">
						<h2 id="sit_title">Better Together TABLET 11 <span className="sound_only">요약정보 및 구매</span></h2>
						<p id="sit_desc"></p>
								<p id="sit_opt_info">
						...
						<tr>
							...
							<td>
								29,000원                <input type="hidden" id="it_price" value="29000"/>
							</td>
						</tr>
